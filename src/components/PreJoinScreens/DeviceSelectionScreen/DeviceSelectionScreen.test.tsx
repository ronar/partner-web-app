...
describe.skip('the DeviceSelectionScreen component', () => {
  beforeEach(() => {
  ...
  describe('when connecting to a room', () => {
    ...
    const wrapper = shallow(<DeviceSelectionScreen userId="" bookingId="" name="test name" roomName="test room name" setStep={() => {}} />);
  ...
  it('should go back to the RoomNameScreen when the Cancel button is clicked', () => {
    ...
    const wrapper = shallow(<DeviceSelectionScreen userId="" bookingId="" name="test name" roomName="test room name" setStep={mockSetStep} />);
